    ...
    <div className="mb-5">
      ...
      >
        ...
        {filteredCountryData.map((location, index) => {
          ...
          const numberIcon = L.divIcon({
            html: `<div style="color: white; font-size: 10px; background: #0DA3DE; border-radius: 50%; width: 35px; height: 35px; display: flex; justify-content: center; align-items: center;border:5px solid white">${markerNumber}</div>`,
            className: "",
            iconSize: [24, 24],
          });
          return (
